...
MAX_CLUSTERS = 8  # Maximum number of wall clusters
MIN_RANDOM_WALLS = 2  # Minimum random walls to add if not enough clusters
MAX_RANDOM_WALLS = 8  # Maximum random walls to add if not enough clusters
